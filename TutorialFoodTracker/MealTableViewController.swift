...
class MealTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
     ...
     let cellIdentifier = "MealTableViewCell"
        ...
        //Fetches th eappropriate meal for the data source layout
    ...
    private func loadSampleMeals() {
        ...
        guard let meal1 = Meal.init(name: "Caprese Salad", photo: photo1, rating: 4)
            else {
                fatalError("Unable to instantiate meal1")
        }
        
        guard let meal2 = Meal.init(name: "Chicken and Potatos", photo: photo2, rating: 5)
            else {
                fatalError("Unable to instantiate meal2")
        }
        guard let meal3 = Meal.init(name: "Pasta with Meatballs", photo: photo3, rating: 3)
            else {
